...
You are a question-generating machine. Your goal is to generate questions based on given contexts. Refer to the examples below for guidance.
...
ㄴCreate only the question text.
